...
function getMaxLifeValues(){
    ...
    if(isNaN(parsedValue) || parsedValue <= 0){
        throw { message: "Invalid user input, should be a number" };
    }
    return parsedValue;
}
let chosenMaxLife;
...
try {
    ...
    console.log(error);
    chosenMaxLife = 100;
    alert('Max Health Should be a Number!')
} finally {
    //used for cleanup, rethrowing an error for analytics
    //mostly not needed, can be ommited.
}
